...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        for (Apartment iter : apartments) {
            if (iter instanceof Apt1Room) ((Apt1Room) iter).clean1Room();
            if (iter instanceof Apt2Room) ((Apt2Room) iter).clean2Rooms();
            if (iter instanceof Apt3Room) ((Apt3Room) iter).clean3Rooms();
